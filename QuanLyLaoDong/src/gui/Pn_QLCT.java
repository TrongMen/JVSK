...
public class Pn_QLCT extends JPanel implements ActionListener,MouseListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnThem)) {
			...
			String tenCT=txTenCT.getText();
			LocalDate nCP=LocalDate.parse(txtNCP.getText().toString());
			LocalDate nKC=LocalDate.parse(txtNKC.getText().toString());
			LocalDate nKT=LocalDate.parse(txtNKT.getText().toString());
			String diadiem=txDD.getText();
			CongTrinh ct=new CongTrinh(maCT,tenCT,nCP,nKC,nKT,diadiem);
			if(dsct.create(ct)) {
				String[] row= {maCT,tenCT,txtNCP.getText().toString(),txtNKC.getText().toString(),txtNKT.getText().toString(),diadiem};
				tblModel.addRow(row);
